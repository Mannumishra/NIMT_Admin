...
const AllCourse = () => {
    ...
    const fetchCourses = async () => {
        try {
            const response = await axios.get('https://api.nimteducation.com/api/get-all-course'); // Adjust the API endpoint accordingly
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmed.isConfirmed) {
            try {
                await axios.delete(`https://api.nimteducation.com/api/delete-course/${id}`); // Adjust the API endpoint accordingly
    ...
    const handleStatusChange = async (courseId, currentStatus) => {
        ...
        try {
            await axios.put(`https://api.nimteducation.com/api/update-course/${courseId}`, { showinHomePage: updatedStatus });
